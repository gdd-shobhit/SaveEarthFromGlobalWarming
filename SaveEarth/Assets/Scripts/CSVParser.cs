...
namespace ExcelToCsv
{
    ...
    public class CSVParser
    {
        ...
        static public bool ConvertExcelToCSV()
        {
            string excelFilePath = Directory.GetCurrentDirectory() + "/StaticData/DataID.xlsx";
            string destinationCsvFilePath = Directory.GetCurrentDirectory() + "/StaticData/Data.csv";
